 ...
 *  under the License.
 */
package domainapp.modules.frd.integtests;
...
import domainapp.modules.frd.FRDModuleManifest;
import domainapp.modules.frd.IFRDDomainConstants;

public abstract class FRDModuleIntegTestAbstract extends IntegrationTestAbstract {
    ...
    public static class ModuleFixtureScriptsSpecificationProvider implements FixtureScriptsSpecificationProvider {
        ...
        public FixtureScriptsSpecification getSpecification() {
            return FixtureScriptsSpecification.builder(IFRDDomainConstants.PKG_FRD_MODULE).with(
