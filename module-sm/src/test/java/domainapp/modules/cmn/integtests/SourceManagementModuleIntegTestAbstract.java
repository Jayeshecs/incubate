 ...
 *  under the License.
 */
package domainapp.modules.cmn.integtests;
...
import domainapp.modules.sm.ISourceDomainConstants;
import domainapp.modules.sm.SourceManagementModuleManifest;

public abstract class SourceManagementModuleIntegTestAbstract extends IntegrationTestAbstract {
    ...
    public static void initSystem() {
        ...
        if(isft == null) {
            isft = new IsisSystemForTest.Builder()
                    ...
                    .with(new SourceManagementModuleManifest() {
                        @Override
    ...
    public static class ModuleFixtureScriptsSpecificationProvider implements FixtureScriptsSpecificationProvider {
        ...
        public FixtureScriptsSpecification getSpecification() {
            return FixtureScriptsSpecification.builder(ISourceDomainConstants.PKG_SOURCE_MANAGEMENT_MODULE).with(
