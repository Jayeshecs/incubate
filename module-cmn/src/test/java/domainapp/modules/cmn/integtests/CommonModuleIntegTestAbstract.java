...
import domainapp.modules.cmn.CommonModuleManifest;
import domainapp.modules.cmn.ICommonDomainConstants;

public abstract class CommonModuleIntegTestAbstract extends IntegrationTestAbstract {
    ...
    public static class ModuleFixtureScriptsSpecificationProvider implements FixtureScriptsSpecificationProvider {
        ...
        public FixtureScriptsSpecification getSpecification() {
            return FixtureScriptsSpecification.builder(ICommonDomainConstants.PKG_COMMON_MODULE).with(
